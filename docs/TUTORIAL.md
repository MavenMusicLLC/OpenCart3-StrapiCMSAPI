...
<img src="../assets/logo.svg" alt="OpenCart Bundle System" width="500">
...
curl -sSL https://raw.githubusercontent.com/MavenMusicLLC/OpenCart3-StrapiCMSAPI/main/install/plesk-install.sh -o install.sh
chmod +x install.sh
...
**Found a bug?** [Create an issue](https://github.com/MavenMusicLLC/OpenCart3-StrapiCMSAPI/issues)
